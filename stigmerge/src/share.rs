    ...
    pub async fn start(&mut self, cancel: CancellationToken) -> Result<()> {
        ...
        match &self.mode {
            ...
            Mode::Seed { path } => {
                ...
                // TODO: spawn seed indexer progress
                /*
        ...
        //TODO: pump events from fetcher
        //self.add_fetch_progress(&cancel, &mut self.tasks, fetcher.subscribe_fetcher_status())?;
        self.tasks
