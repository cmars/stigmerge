...
use veilid_core::{ConfigCallbackReturn, FourCC, TypedKey, TypedKeyGroup, TypedSecretGroup, VeilidAPIError};
...
pub fn callback(state_dir: String, ns: Option<String>, key: String) -> ConfigCallbackReturn {
    match key.as_str() {
        "program_name" => Ok(Box::new(String::from("stigmerge"))),
        ...
        "network.routing_table.bootstrap" => Ok(Box::new(vec!["bootstrap-v1.veilid.net".to_string()])),
